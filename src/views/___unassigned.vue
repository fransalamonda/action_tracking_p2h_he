<template>
  ...
  <div class="bg-white py-24 sm:py-32">
    ...
    <div class="p-2 overflow-x-auto">
      ...
      <div class="p-4 bg-white border border-gray-200 rounded-lg shadow overflow-x-auto">
            ...
            <table class="table w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="w-100 px-6 py-3">
                          Date
                        </th>
                        <th scope="col" class="w-1/2 px-6 py-3">
                          Checkpoint
        ...
        <!-- <table class="min-w-full border border-neutral-200 text-center text-sm font-light text-surface dark:border-black dark:text-white">
                    
                    <thead class="text-xl-body-1 text-green-600  font-mono	 uppercase bg-gray-50 dark:bg-white dark:text-gray-400">
                   
                      <tr>
                          <th class="border border-slate-300 text-black text-bold">Doc Unit</th>
                          <th class="border border-slate-300 text-black text-bold">Equipment ERP</th>
                          <th class="border border-slate-300 text-black text-bold">Shift</th>
                          <th class="border border-slate-300 text-black text-bold">Date</th>
                          <th class="border border-slate-300 text-black text-bold">Kode Unit</th>
                          <th class="border border-slate-300 text-black">Nama Unit</th>
                          <th class="border border-slate-300 text-black">Merk</th>
                          <th class="border border-slate-300 text-black">Group HE</th>
                          <th class="border border-slate-300 text-black">Nama Checkpoint</th>
                          <th class="border border-slate-300 text-black">Catatan Checkpoint</th>
                          <th class="border border-slate-300 text-black">Sction</th>
                      </tr>
                    </thead>

                    <tbody> -->
                        
                      <!-- <tr class="bg-white border-b dark:bg-white dark:border-gray-700 font-mono " v-for="item in barang" :key="item.equipment_id">
                          <td class="p-2 border-b border-l text-left text-black">{{ item.equipment_id }}</td>
                          <td class="p-2 border-b border-l text-left text-black">{{ item.checkpoint }}</td>
                          <td class="py-2 border-b border-l font-medium whitespace-nowrap text-sm text-gray-800 dark:text-gray-200 text-left">{{ item.checkpoint_detail }}</td>
                          <td class="hover:flex-row py-2 border-b border-l font-medium text-gray-900 whitespace-nowrap dark:text-white text-left">{{ item.checklist_notes }}</td>
                          <td class="hover:flex-row py-2 border-b border-l font-medium text-gray-900 whitespace-nowrap dark:text-white text-left">{{ item.conditions }}</td>
                          <td class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-left"></td>
                          <td class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-left"></td>
                          <td class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-left"></td>
                          <td class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-left"></td>
                          <td class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white text-left"></td>
  ...
  <div v-if="showModal" class="modal fixed left-0 top-0 z-50 w-full flex items-center marker:justify-center bg-gray-500 bg-opacity-75">
    ...
    <!-- <div class="bg-white p-8 rounded shadow-md  max-w-lg"> -->
    <div class="bg-white mdi-video-wireless-outline p-6 rounded-lg">
    
      <!-- Modal Header -->
      <div class="mb-4">
      <h2 class="text-xl font-bold">Action Form</h2>
      <p>Complete Form to Update this case</p>
      </div>
          ...
          <div class="shadow-md p-2">
            ...
            <form class="max-w-md mx-auto">
              <div class="relative z-0 w-full mb-5 group">
                ...
                <input v-model="docno" type="text" name="docno" id="docno" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  required disabled />

                  <label for="docno" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Doc No</label>
              </div>

              <div class="relative z-0 w-full mb-5 group">
                  <input v-model="operator" type="text" name="date_act" id="date_act" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>

                  <label for="date_act" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Operator</label>
              </div>
              ...
              <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input v-model="unitkode" type="text" name="kd_unit" id="kd_unit" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>
                    <label for="kd_unit" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Unit</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input v-model="unitnama" type="text" name="nm_unit" id="nm_unit" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>
                    <label for="nm_unit" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Unit Name</label>
                </div>
              </div>
              ...
              <div class="relative z-0 w-full mb-5 group">
                  <input v-model="equmerek" type="text" name="merk_unit" id="merk_unit" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>

                  <label for="merk_unit" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Merk</label>
              </div>
      ...
      <!-- Modal Footer -->
      <div>
      <button  @click="ModalClose"  class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
        Close
      </button>
      <button class="bg-red-900 hover:bg-red-950 text-white font-bold py-2 px-4 rounded ml-2">
        Action
      </button>
      </div>
            ...
            <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
              <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      <DialogTitle as="h3" class="text-base font-semibold leading-6 text-gray-900">Action Form</DialogTitle>
                      <div class="mt-2">
                        <form>
                          <div class="space-y-12">
                            <div class="border-b border-gray-900/10 pb-12">
                              <h2 class="text-base font-semibold leading-7 text-gray-900"></h2>
                              <p class="mt-1 text-sm leading-6 text-gray-600">Complete form to update this case</p>
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button type="button" class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto" @click="open = false">Ok</button>
                </div>
              </DialogPanel>
            </TransitionChild>
          </div>
...
export default {
    ...
    methods: {
      ...
      ModalEdit(item){
        ...
        this.equseri = item.checklist_notes;
