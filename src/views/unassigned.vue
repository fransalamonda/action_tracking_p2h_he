<template>
  ...
  <div class="bg-white py-24 sm:py-32">
    ...
    <div class="p-2 overflow-x-auto">
      ...
      <div class="p-4 bg-white border border-gray-200 rounded-lg shadow overflow-x-auto">
            ...
            <table class="table w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="w-[80px] px-6 py-3">
                          Date
                        </th>
                        <th scope="col" class=" px-6 py-3">
                          Checkpoint
                ...
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" v-for="item in barang" :key="item.ID_investigation">

                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          {{ item.doc_number }}
                        </th>
                        <td  scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          {{ item.nik }} {{ item.operator_name }}
                        </td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          {{ formatDate(item.created_at) }}
                        </td>
                        <td class="w-3/4 px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                          {{ item.nama_checkpoint }}
                        </td>
                        <td class="px-6 py-4">
                          {{ item.catatan }}
                        </td>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <button type="button" class="inline-flex w-full justify-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto" @click="ModalEdit(item)" >Action</button>
                        </td>
                    </tr>
  ...
  <div  v-if="showModal" id="default-modal" tabindex="-1" aria-hidden="true" class="modal overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    
    <div class="bg-white mdi-video-wireless-outline p-6 rounded-lg">
    
      <!-- Modal Header -->
      <div class="mb-0">
        <h2 class="text-center text-xl font-bold">Action Form</h2>
        <p class="text-center">Complete Form to Update this case</p>
      </div>

      <div class="my-3 mb-1">
        <!-- max-h-72 -->
        <div class="grid grid-cols-3 divide-x overflow-y-auto h-96"> 

          <div class="shadow-md p-2">

            <!-- <div class="relative mx-auto border-gray-200 dark:border-gray-200 bg-gray-200 border-[14px] rounded-[2.5rem] h-[500px] w-[300px] shadow-xl"> -->
              <!-- <div class="w-[148px] h-[18px] bg-gray-800 top-0 rounded-b-[1rem] left-1/2 -translate-x-1/2 absolute"></div> -->
              <!-- <div class="h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[124px] rounded-s-lg"></div>
              <div class="h-[46px] w-[3px] bg-gray-800 absolute -start-[17px] top-[178px] rounded-s-lg"></div>
              <div class="h-[64px] w-[3px] bg-gray-800 absolute -end-[17px] top-[142px] rounded-e-lg"></div> -->
              
              <p class="caption-top text-lg font-bold">
              General Information 
            </p>
            <ol class="relative border-s border-gray-200 dark:border-gray-700">                  
                <li class="my-2 mb-0 ms-2 h-auto" >
                    <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                    <!-- <time class="mb-1 text-sm font-normal leading-none text-gray-400 dark:text-gray-500"></time> -->
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Doc Number</h3>
                    <p class="mb-4 text-sm font-normal text-gray-500 dark:text-gray-400">{{ docno }}</p>
                   
                </li>
                <li class="my-2 mb-0 ms-2 h-auto">
                    <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                   
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Operator</h3>
                    <p class="mb-4 text-sm font-normal text-gray-500 dark:text-gray-400">{{ operator }}</p>
                   
                </li>
                <li class="my-2 mb-0 ms-2">
                    <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Unit</h3>
                    <p class="mb-4 text-sm font-normal text-gray-500 dark:text-gray-400">{{ unitkode }} {{ unitnama }}</p>
                   
                </li>
                <li class="my-2 mb-0 ms-2" >
                    <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Checkpoint</h3>
                    <p class="mb-4 text-sm font-normal text-gray-500 dark:text-gray-400"> {{ checkpoint }}</p>
                   
                </li>
                <li class="my-2 mb-0 ms-2">
                    <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Checkpoint Notes</h3>
                    <p class="mb-4 text-sm font-normal text-gray-500 dark:text-gray-400"> {{ checkpointnotes }}</p>
                   
                </li>
                <li class="my-2 mb-0 ms-2" >
                    <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Notes</h3>
                    <p class="mb-4 text-sm font-normal text-gray-500 dark:text-gray-400"> {{ notes }}</p>
                   
                </li>
                <li class="my-2 mb-0 ms-2">
                    <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Area</h3>
                    <p class="mb-4 text-sm font-normal text-gray-500 dark:text-gray-400">  {{ area }}</p>
                   
                </li>
              </ol>
            <div class="my-2 mb-0 button-list">
              <button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Open Image</button>
          ...
          <div class="shadow-md p-2">
            ...
            <form class="max-w-md mx-auto">
              ...
              <div class="relative z-0 w-full mb-5 group">
                <label for="countries_disabled" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Departemen PIC</label>
                <select  id="pic_departemen" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" v-model="selecteddept" @change="StatusDept">
                  <option v-for="picdepartemens in picdepartemen" :value="picdepartemens.id" :key="picdepartemens.id" :selected="index === 0">
                            {{ picdepartemens.department_pic }}
                          </option>
                </select>
              ...
              <div class="relative z-0 w-full mb-5 group">
                  <input v-model="emailpic" type="text" name="date_act" id="date_act" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>

                  <label for="date_act" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email PIC</label>
              </div>

              <div class="relative z-0 w-full mb-5 group">
                
                  <textarea  type="text" name="date_act" id="date_act" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" rows="5" placeholder=" " required />

                  <label for="date_act" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Required Action</label>
              </div>
              ...
              <!-- <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input v-model="equmodel" type="text" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" name="model_unit" id="model_unit" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>
                    <label for="model_unit" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Model</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
                    <input v-model="equseri" type="text" name="seri_unit" id="seri_unit" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>
                    <label for="seri_unit" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Seri</label>
                </div>
              </div> -->
              <!-- <div class="relative z-0 w-full mb-5 group">
                  <input v-model="checkpoint" type="text" name="date_act" id="date_act" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>

                  <label for="date_act" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Checkpoint</label>
              </div> -->
              <!-- <div class="relative z-0 w-full mb-5 group">
                  <input v-model="checkpointnotes" type="text" name="date_act" id="date_act" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>

                  <label for="date_act" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Checkpoint Notes</label>
              </div> -->
              
              <!-- <div class="relative z-0 w-full mb-5 group">
                  <input v-model="notes" type="text" name="merk_unit" id="merk_unit" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>

                  <label for="merk_unit" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Notes</label>
              </div> -->
          ...
          <div class="shadow-md p-2">
            <p class="caption-top text-lg font-bold"> </p>
            
            <div class="relative z-0 w-full mb-5 group">
              <input v-model="invtgl" type="text" name="date_act" id="date_act" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required disabled/>
            ...
            <div class="relative z-0 w-full mb-5 group">
              <label for="countries_disabled" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Priority</label>
              <select  id="countries_disabled" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" v-model="selectedprioritas" @change="StatusChange">
                <option v-for="prioritass in prioritas" :value="prioritass.id" :key="prioritass.id" :selected="index === 0">
                          {{ prioritass.priority }}
                        </option>
              </select>
            ...
            <div class="relative z-0 w-full mb-0 group">
                ...
                <label for="date_act" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Target Completion Date </label>
                <div class="relative max-w-sm py-3">
            ...
            <div class="relative z-0 w-full mb-5 group">
              <label for="countries_disabled" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Work Status *</label>
              <select  id="countries_disabled" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" v-model="selectedwork" @change="StatusChange">
                <option v-for="statusworks in statuswork" :value="statusworks.id" :key="statusworks.id" :selected="index === 0">
                          {{ statusworks.work_status_name }}
                        </option>
              </select>
            </div>
      ...
      <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
          <button  @click="ModalClose"  class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Close</button>
          <button class="bg-red-900 hover:bg-red-950 text-white font-bold py-2 px-4 rounded ml-2">Action</button>
    </div>

    </div>
  
  </div>
  <!-- <div v-if="showModal" class="modal fixed left-0 top-0 z-50 w-full flex items-center marker:justify-center bg-gray-500 bg-opacity-75"> -->
...
export default {
    ...
    props: ['customProp'],
    watch: {
      customProp(newIDplant) {
        this.datakirim = newIDplant;
        //console.log('Perubahan props:', this.datakirim );
        // Lakukan sesuatu ketika nilai props berubah
        // UserService.getUnassigned(newIDplant).then(
        // (response) => {
    ...
    methods: {
      formatDate(date) {
        if (date) {
          return format(new Date(date), 'd MMMM, y'); // Customize the format as needed
        }
        return ''; // Handle the case where the date is not defined
      },
      ...
      ModalEdit(item){
        this.docno = item.doc_number;
        this.operator = item.nik+' - '+item.operator_name;
        this.invtgl = this.formatDate(item.created_at);
        this.unitkode = item.equip;
        this.unitnama = item.nama_unit;
        this.checkpoint = item.nama_checkpoint;
        this.checkpointnotes = item.catatan;
        this.notes = item.catatan_tambahan;
        this.equmerek = item.checklist_notes;
        this.area = item.area_HE;
        this.deptpic();
        this.priorityget();
        this.workstatus();
        this.showModal = true;
      ...
      berubahPlant(){
        ...
        this.datakirim =this.customProp;
        UserService.get_Unassigned(this.datatoken, this.customProp).then(
          (response) => {
            this.barang = response.data.data;
            console.log(this.barang[0]);
            this.isLoading = false;
          },
          (error) => {
            this.plant =
      ...
      deptpic(){
        ...
        UserService.get_Deptpic(this.datatoken).then(
          (response) => {
            this.picdepartemen = response.data.data;
            this.selecteddept ="Select Dept";
            //if(this.statuswork.length > 0){
            //this.selecteddept = this.picdepartemen[0].id;
            //}
            this.isLoading = false;
          },
          (error) => {
      ...
      priorityget(){
        this.datatoken = this.$store.state.auth.user.expires_in;
        UserService.get_Priority(this.datatoken).then(
          (response) => {
            this.prioritas = response.data.data;
            if(this.prioritas.length > 0){
              this.prioritas = response.data.data;
            this.selectedprioritas = this.prioritas[0].id;
          }
            this.isLoading = false;
          },
          (error) => {
      ...
      workstatus(){
        ...
        UserService.get_Workstatus(this.datatoken).then(
          (response) => {
            this.statuswork = response.data.data;
            if(this.statuswork.length > 0){
              this.statuswork = response.data.data;
            this.selectedwork = this.statuswork[0].id;
          }
            this.isLoading = false;
          },
          (error) => {
      ...
      StatusDept(){
        this.emailpic='fran.monda@cemindo.com';
      }
